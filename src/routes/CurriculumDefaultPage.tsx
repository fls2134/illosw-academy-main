        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg border-2 border-slate-200 shadow-sm p-6 md:p-8 mb-8 md:mb-10">
            ...
            <div className="space-y-4 text-sm md:text-base text-slate-700 leading-relaxed">
              <p>
                대학 IT 계열 공학과 입시와 정보계열 특성화/마이스터고 입시에서
                중요한 평가요소는
              </p>
              <p>
                1. 학생이 가진 전공 역량과 발전 의지 <br /> 2. 학생이 보유한
                기술에 대한 방향 일관성
              </p>
              <p>
                입니다. 컴퓨터 과학에 대한 이해가 부족한 학원의 경우, 상담 시 왜
                이 항목을 수강해야 하는지 알려주지 않고 무작정 강의로 밀어넣는
                경우가 있습니다.
              </p>
              <p className="font-medium text-slate-800">
                {COMPANY_NAME}는 무엇을 배우는지에 앞서, 왜 배우는지부터
                설계합니다. 학생의 적성을 찾아, 나아가야할 단 하나의 길(一路)을
                찾아드립니다.
              </p>
            </div>
          </div>
